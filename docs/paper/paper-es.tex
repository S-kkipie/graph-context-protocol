...
capacidad). Un principal $K$ tiene un rol opcional; su conjunto de capacidades
efectivas $\mathit{effective}(K)$ es la unión de las capacidades planas propias de
$K$ ($K.\textit{capabilities}$) y las heredadas transitivamente a través de la
cadena de roles (precedencia propia ante identificadores de capacidad duplicados),
calculándose la parte del rol con \texttt{getEffectiveCapabilities}.
...
\textbf{P2~(solidez de autorización).}
