...
% the three-model, four-run-set run set (llama3.1:8b, qwen3:4b x2 independent
% run sets, qwen2.5:32b, 2026-08-11); includes the delegation scenario, the
% discovery / tool-prompt coupling levers, a reproducible technical
